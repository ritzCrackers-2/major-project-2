...
while running:
    ...
    neon_green = (0, 255, 80)
    pygame.draw.line(screen, neon_green, (lane_left_actual, 0 - camera_offset_y),
                     (lane_left_actual, height - camera_offset_y), 4)
    pygame.draw.line(screen, neon_green, (lane_right_actual, 0 - camera_offset_y),
                     (lane_right_actual, height - camera_offset_y), 4)
    ...
    player_box = pygame.Rect(width // 2 - player_radius, height // 2 - player_radius, player_radius * 2,
                             player_radius * 2)
