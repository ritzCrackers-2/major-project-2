...
while running:
    ...
    pygame.draw.circle(screen, neon_green, (player_x, player_y), player_radius, 2)

    player_box = pygame.Rect(player_x-player_radius, player_y-player_radius, player_radius*2, player_radius*2)
